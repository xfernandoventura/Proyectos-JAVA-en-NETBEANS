...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       JOptionPane.showMessageDialog(this,c.establecerconexion(txtusuario.getText(), txtcontraseña.getText()));
       if(c.getconexioncorrecta() == true)
       {
           MenuInformes mp= new MenuInformes(c);
           mp.setVisible(true);
